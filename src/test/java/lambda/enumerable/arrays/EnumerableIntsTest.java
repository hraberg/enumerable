...
public class EnumerableIntsTest extends TestBase {
    ...
    public void eachReturnsArray() throws Exception {
        assertArrayEquals(intsOneToFive, each(intsOneToFive, λ(n, (Integer) n)));
    }
