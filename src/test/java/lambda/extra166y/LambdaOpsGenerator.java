...
class LambdaOpsGenerator {
    public static void main(String[] args) throws Exception {
        ...
        out.println(" * inheriting from {@link lambda.Fn0} it creates lambdas implementing the interfaces defined in");
        out.println(" * {@link extra166y.Ops}, to be used together with {@link extra166y.ParallelArray}.");
        out.println(" * <p>");
        out.println(" * <i>This file was generated by " + LambdaOpsGenerator.class.getName() + ".</i>j");
        out.println(" */");
